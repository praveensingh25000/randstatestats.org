...
//echo "<pre>";print_r($_SESSION['searchedfieldsweather']);echo "</pre>";die;
...
if(!empty($databaseDetail)){
	...
	if((!empty($columns) && isset($searchedfields['syear']) && isset($searchedfields['eyear'])) || (!empty($columns) && isset($searchedfields['smonth']) && isset($searchedfields['emonth']))) {
		...
		if(isset($columns['yearsasrows']) && isset($searchedfields['syear']) && $searchedfields['syear']!='' && isset($searchedfields['syear']) && $searchedfields['eyear']!='') {
		...
		if(isset($columns['yearsascolumns']) && $columns['yearsascolumns']!='') {
		...
		if(isset($columns['monthsascolumns']) && $columns['monthsascolumns']!=''){
...
//echo "<pre>";print_r($searchedData);echo "</pre>";die;
?>
