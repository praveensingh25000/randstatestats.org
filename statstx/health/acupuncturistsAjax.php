...
if(!empty($totalallCategoryDetail) && !empty($relatedCounty)) {
	...
	$data .= '<div class="form-div">
					<p><span class="choose">'.((isset($lang['lbl_one_more_categories']))?$lang['lbl_one_more_categories']:'').'</span>&nbsp;&nbsp;</p></div>';
	...
	$data .= '<div class="form-div">
					<p><span class="choose">'.((isset($lang['lbl_choose_county_cities']))?$lang['lbl_choose_county_cities']:'').'</span>&nbsp;&nbsp;</p></div>';
