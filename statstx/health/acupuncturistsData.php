...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ( accup.Area in (".$area.") or accup_areas.countycode in (".$area.") ) and accup.category IN (".$category.") and txplaces.areacode IN (".$states.") ".$joinStr." limit 4000";
