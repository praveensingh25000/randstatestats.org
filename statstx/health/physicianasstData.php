...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ( phyasst.Area in (".$area.") or ".$tablesnamecountyarea.".countycode in (".$area.") ) and ".$tablesname.".category IN (".$category.") and txplaces.areacode IN (".$states.") ".$joinStr." limit 4000";
