...
//categpry Detail
$allCategoryDetail_res  = $admin->getTableDataUniversal($tablesnamecat,'LIMIT 5000');
$totalallCategoryDetail = $dbDatabase->getAll($allCategoryDetail_res);

//age detail
$allCategoryDetailages_res  = $admin->getTableDataUniversal($tablesname,'LIMIT 5000');
$totalallAgeCategoryDetail = $dbDatabase->getAll($allCategoryDetailages_res);

$allCategoryDetail_res  = $admin->getTableDataUniversal($tablesnamecountyarea,'LIMIT 5000');
