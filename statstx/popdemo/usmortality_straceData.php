...
if(!isset($_SESSION['usmortality_strace']) || (isset($_SESSION['usmortality_strace']) && !isset($_SESSION['usmortality_strace']['dbid']))){
	header('location: usmortality_strace.php');
}

$searchedfields = $_SESSION['usmortality_strace'];
...
$categoryAll = $categoryStr = $stateStr = $stateStrAll = $areasAll = $areaStr = $cat1All = $cat1Str = $cat2Str =	$cat2All ='';
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".category in (".$categoryStr.") and ".$tablesname.".cat2 IN (".$cat2Str.") and ".$tablesname.".cat1 IN (".$cat1Str.") ".$joinStr." limit 4000";
