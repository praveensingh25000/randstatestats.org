...
$cat3 = '';
if(isset($searchedfields['cat3'])){
	foreach($searchedfields['cat3'] as $keyArea => $cat3c){
		$cat3 .= "'".$cat3c."',";
	}
}

$cat3 = substr($cat3, 0, -1);

$cat1 = $searchedfields['cat1'];

$area = implode(',', $searchedfields['areacode']);

$category = implode(',', $searchedfields['category']);

$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$area.") and ".$tablesname.".Cat1 = '".$cat1."' and ".$tablesname.".Cat3 in (".$cat3.")  and ".$tablesname.".Category in (".$category.") ".$joinStr." limit 4000";
