...
#live Site URL For This Page: http://tx.rand.org/stats/economics/median_income.html
********************************************/
	...
	<section id="inner-content" <?php if(mysql_num_rows($related_DB)<=0){ ?> class="conatiner-full" <?php } ?>>
		...
		<div class="categorie-data">
			...
			<form method="post" id="frmPost" name="frmPost" action="">
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_choose_metropolitan_area'])){ echo $lang['lbl_choose_metropolitan_area']; } ?></span>&nbsp;&nbsp;
						States A-W:
					</p>
					<div class="table-div">
				...
				$(document).ready(function() {							
					...
					$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, { preventDuplicates: true,
						...
						onAdd: function (item) {
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statstx/economics/median_income_ajax.php',
								type: 'post',
