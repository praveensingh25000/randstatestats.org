...
if(!empty($databaseDetail)){
	...
	foreach($columnDisplaySettings as $keyColumnDisplay => $columnSettings){
		...
		if($columnSettings['column_name']!='avg' && $columnSettings['column_name']!='Avg' && $columnSettings['column_name']!='Avg.' && $columnSettings['column_name']!='avg.' && $columnSettings['column_name']!='Average' && $columnSettings['column_name']!='average' && $columnSettings['column_name']!='Total' && $columnSettings['column_name']!='total' ){
