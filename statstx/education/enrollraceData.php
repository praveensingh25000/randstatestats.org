...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$area.") and ".$tablesnamecat.".catcode in (".$category.") ".$joinStr." limit 4000";
