...
* @live Site URL For This Page: http://tx.rand.org/stats/education/performance.html
********************************************/
	...
	<section id="inner-content" <?php if(mysql_num_rows($related_DB)<=0){ ?> class="conatiner-full" <?php } ?>>
		...
		<div class="categorie-data">
			...
			<form method="post" id="frmPost" name="frmPost" action="" novalidate="novalidate">
				...
				<!-- form -->
				<input type="hidden" name="session_setter" value="performance">
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_select_student_performance'])){ echo $lang['lbl_select_student_performance']; } ?></span>&nbsp;&nbsp;
				...
				$(document).ready(function() {	
					...
					$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, { preventDuplicates: true,
						...
						onAdd: function (item) {
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statstx/education/performanceAjax.php',
								type: 'post',
