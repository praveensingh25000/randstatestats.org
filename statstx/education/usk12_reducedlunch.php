...
#live Site URL For This Page: http://tx.rand.org/stats/education/usk12_reducedlunch.html
********************************************/
				...
				$(document).ready(function() {	
					...
					$('#sector').change(function(){
						...
						if(states!='' && states != "NULL"){
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statstx/education/usk12_reducedlunch_ajax.php',
								type: 'post',
