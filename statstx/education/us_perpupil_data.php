...
if(!isset($_SESSION['searchedfieldsdistperpupil']) || (isset($_SESSION['searchedfieldsdistperpupil']) && !isset($_SESSION['searchedfieldsdistperpupil']['dbid']))){
	header('location: us_perpupil.php');
}

$searchedfields = $_SESSION['searchedfieldsdistperpupil'];
