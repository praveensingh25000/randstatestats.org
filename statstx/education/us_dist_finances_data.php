...
if(!isset($_SESSION['searchedfieldsdistfinances']) || (isset($_SESSION['searchedfieldsdistfinances']) && !isset($_SESSION['searchedfieldsdistfinances']['dbid']))){
	header('location: us_dist_finances.php');
}

$searchedfields = $_SESSION['searchedfieldsdistfinances'];
