...
#live Site URL For This Page: http://ny.rand.org/stats/community/us_hatecrimes.html
********************************************/
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_select_state_reporting_agencies'])){ echo $lang['lbl_select_state_reporting_agencies']; } ?></span>&nbsp;&nbsp;
						<?php if(isset($lang['lbl_states_crimes_reporting'])){ echo $lang['lbl_states_crimes_reporting']; } ?>
					</p>
					<div class="table-div">
				...
				$(document).ready(function() {							
					...
					$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, { tokenLimit: 1, preventDuplicates: true,
						...
						onAdd: function (item) {
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsca/community/us_hatecrimes_ajax.php',
								type: 'post',
