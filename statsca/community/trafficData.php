...
if(!isset($_SESSION['traffic']) || (isset($_SESSION['traffic']) && !isset($_SESSION['traffic']['dbid']))){
	header('location: traffic.php');
}

$searchedfields = $_SESSION['traffic'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Category IN (".$categoryStr.") and ".$tablesname.".Cat1 IN (".$cat1Str.") ".$joinStr." limit 4000";
