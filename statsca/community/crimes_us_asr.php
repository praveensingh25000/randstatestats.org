<?php
/******************************************
* @Modified on Feb 08, 2013, Mar 08,2013
* @Package: Rand
	...
	<section id="inner-content" <?php if(mysql_num_rows($related_DB)<=0){ ?> class="conatiner-full" <?php } ?>>
		...
		<div class="categorie-data">
			...
			<form method="post" id="frmPost" name="frmPost" action="" novalidate="novalidate">
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_please_select_reporting_agencies'])){ echo $lang['lbl_please_select_reporting_agencies']; } ?></span>&nbsp;&nbsp;
				...
				$(document).ready(function() {							
					...
					$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, { tokenLimit: 1, preventDuplicates: true,
						...
						onAdd: function (item) {
							...
							jQuery.ajax({
								url: URL_SITE+'/statsca/community/crimes_us_asr_ajax.php',
								type: 'post',
