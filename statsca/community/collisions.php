...
if(isset($_POST['getresults'])){
	...
	if(isset($validity_on) && $validity_on == '0') {
		...
		header('location: collisionsData.php');
		exit;
	}
}
...
$allCategoryDetail_res  = $admin->getDistinctColumnValuesUniversal($tablesname , $column='Area', $columns = "", $limit = "");
		...
		<div class="categorie-data">
			...
			<div id="" class="">
				<form method="post" id="frmPost" name="frmPost" action="" novalidate="novalidate">
					<!-- form -->
					<input type="hidden" name="session_setter" value="collisions"/>
					<div class="form-div">
						<p>
						   <span class="choose"><?php if(isset($lang['lbl_spease_choose_county'])){ echo $lang['lbl_spease_choose_county']; } ?> </span>
						</p>
						<div class="table-div">
					...
					$(document).ready(function() {							
						...
						$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, {		
							...
							onAdd: function (item) {
								...
								jQuery.ajax({
									url: URL_SITE+'/statsca/community/collisionsAjax.php',
									type: 'post',
