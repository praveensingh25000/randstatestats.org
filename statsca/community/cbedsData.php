...
if(!isset($_SESSION['freemeals_det']) || (isset($_SESSION['freemeals_det']) && !isset($_SESSION['freemeals_det']['dbid']))){
	header('location: freemeals_det.php');
}

$searchedfields = $_SESSION['freemeals_det'];
