...
if(!isset($_SESSION['collisions']) || (isset($_SESSION['collisions']) && !isset($_SESSION['collisions']['dbid']))){
	header('location: collisions.php');
}

$searchedfields = $_SESSION['collisions'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Category IN (".$categoryStr.") and ".$tablesname.".Cat1 IN (".$cat1Str.") and ".$tablesname.".Area IN (".$stateStr.") ".$joinStr." limit 4000";
