...
if(!isset($_SESSION['crimes']) || (isset($_SESSION['crimes']) && !isset($_SESSION['crimes']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: crimes.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
