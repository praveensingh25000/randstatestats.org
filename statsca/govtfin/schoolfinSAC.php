...
* @live URL: http://ca.rand.org/stats/govtfin/schoolfinSAC.html
********************************************/
...
if(isset($_POST['getresults'])){
	...
	if(isset($validity_on) && $validity_on == '0') {
		...
		header('location: schoolfinSACData.php');
		exit;
	}
}
					...
					$(document).ready(function() {							
						...
						$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, { tokenLimit: 1, preventDuplicates: true,
							...
							onAdd: function (item) {
								...
								jQuery.ajax({
									url: URL_SITE+'/statsca/govtfin/schoolfinSACAjax.php',
									type: 'post',
