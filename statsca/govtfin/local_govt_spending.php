...
#live Site URL For This Page: http://tx.rand.org/stats/govtfin/local_govt_spending.html
********************************************/
	...
	<section id="inner-content" <?php if(isset($related_DB) && mysql_num_rows($related_DB) <= 0) { ?> class="conatiner-full" <?php } ?>>
		...
		<div class="categorie-data">
			...
			<form method="post" id="frmPost" name="frmPost" action="" novalidate="novalidate">
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_choose_category_local_govt'])){ echo $lang['lbl_choose_category_local_govt']; } ?></span>&nbsp;&nbsp;
					</p>
					<div class="table-div">
				...
				<div class="form-div">
					...
					<div class="table-div">
						<select size="4" name="sector" id="sector" class="required">
							...
							<option value="5">Independent School Districts/Educ. Service Agency </option>
						</select>
					</div>
				  </div>
				<!-- /form -->
				...
				$(document).ready(function() {	
					...
					$('#sector').change(function(){
						...
						if(states!='' && states != "NULL" && cat2!='' && cat2 != "NULL"){
							loader_show();
							jQuery('#timePeriod').hide();
							jQuery('#submitButtons').hide();
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsca/govtfin/local_govt_spending_ajax.php',
								type: 'post',
