<?php
/******************************************
* @Modified on Feb 16, 2013, Mar 08, 2013
* @Package: Rand
					...
					<div class="form-div">
						...
						<div class="pL10 pB10">
						    <?php foreach($totalallCategoryDetail as $categoryDetail) { ?>				
								<input class="required" type="checkbox" value="<?php echo $categoryDetail;?>" name="Category[]">
					...
					$(document).ready(function() {							
						...
						$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, {		
							...
							onAdd: function (item) {
								...
								jQuery.ajax({
									url: URL_SITE+'/statsca/govtfin/cffAjax.php',
									type: 'post',
