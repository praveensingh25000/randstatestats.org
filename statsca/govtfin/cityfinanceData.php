<?php
/******************************************
* @Modified on March 04, 2013, march 08, 2013
* @Package: Rand
...
if(!isset($_SESSION['cityfinance']) || (isset($_SESSION['cityfinance']) && !isset($_SESSION['cityfinance']['dbid']))){
	header('location: cityfinance.php');
}

$searchedfields = $_SESSION['cityfinance'];
