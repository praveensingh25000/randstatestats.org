...
if(!isset($_SESSION['usmortality_age']) || (isset($_SESSION['usmortality_age']) && !isset($_SESSION['usmortality_age']['dbid']))){
	header('location: usmortality_age.php');
}

$searchedfields = $_SESSION['usmortality_age'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$areaStr.") and ".$tablesname.".Category IN (".$categoryStr.") and ".$tablesname.".Cat1 IN (".$cat1Str.") and ".$tablesname.".State IN (".$stateStr.") ".$joinStr." limit 4000";
...
<section id="container">
	 ...
	 <div class="main-cell">
				...
				<table id="" class="data-table">
					<tbody>
						...
						<tr>
							...
							?>
							<td align="left"><?php if(is_numeric($fieldValue) && $fieldValue<0){ echo 'NA'; } else if(is_numeric($fieldValue) && trim(strtolower($keyField)) != 'year' && trim(strtolower($keyField))!= 'age'){ 
						
						echo number_format ($fieldValue, 2);
						} else { echo $fieldValue; } ?></td>
							<?php } ?>
						</tr>
		...
		<?php } else { ?>			
			<div class="clear"></div>
			<div class="pT20 txtcenter"><b>No Record Found For This Search Criteria</b></div>
		<?php } ?>
