...
//categpry Detail
$allCategoryDetail_res  = $admin->getTableDataUniversal($tablesnamecat,'LIMIT 4000');
...
//echo "<pre>";print_r($totalallAgeCategoryDetail);echo "</pre>"; die;

$allCategoryDetail_res  = $admin->getTableDataUniversal($tablesnamecountyarea,'LIMIT 4000');
