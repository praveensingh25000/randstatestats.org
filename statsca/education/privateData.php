...
if(!isset($_SESSION['private']) || (isset($_SESSION['private']) && !isset($_SESSION['private']['dbid']))){
	header('location: private.php');
}

$searchedfields = $_SESSION['private'];
...
if(isset($searchedfields['schooldistrict']) && count($searchedfields['schooldistrict'])>0){
...
$sql = "select ".$columnstobefetched." from cds, private, private_cats, cd_new where 1 ".$fieldsStrWhere." and ".$tablesname.".Category IN (".$category.") ".$joinStr." limit 4000";
