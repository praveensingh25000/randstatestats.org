...
#live Site URL For This Page: http://tx.rand.org/stats/education/usk12_pupilratio.html
********************************************/
				...
				$(document).ready(function() {	
					...
					$('#sector').change(function(){
						...
						if(states!='' && states != "NULL"){
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsca/education/usk12_pupilratio_ajax.php',
								type: 'post',
					...
					$("#search_criteria_duplicates").tokenInput(<?php echo $filtervaluesJson; ?>, { tokenLimit: 1, preventDuplicates: true,
						...
						onDelete: function (item) {
							...
							jQuery('#submitButtons').hide();
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsny/education/usk12_pupilratio_ajax.php',
								type: 'post',
								data: 'dbid=<?php echo $dbid; ?>&states='+states+'&sector='+sector,
								success: function(dataresult){
									loader_unshow();
