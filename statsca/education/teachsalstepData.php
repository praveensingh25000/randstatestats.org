...
* @live URL: http://ca.rand.org/stats/education/teachsalstep.html
********************************************/
...
if(!isset($_SESSION['teachsalstep']) || (isset($_SESSION['teachsalstep']) && !isset($_SESSION['teachsalstep']['dbid']))){
	header('location: teachsalstep.php');
}

$searchedfields = $_SESSION['teachsalstep'];
...
if(isset($searchedfields['Category'])){
	$CategoryStr = '';
	foreach($searchedfields['Category'] as $keyCat => $Category){
