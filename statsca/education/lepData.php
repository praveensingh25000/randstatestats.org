...
if(!isset($_SESSION['lep']) || (isset($_SESSION['lep']) && !isset($_SESSION['lep']['dbid']))){
	header('location: lep.php');
}

$searchedfields = $_SESSION['lep'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$cdsStr.") and ".$tablesname.".Category IN (".$categoryStr.") and ".$tablesname.".Cat1 IN (".$cat1Str.") ".$joinStr." limit 4000";
