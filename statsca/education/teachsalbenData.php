...
* @live URL: http://ca.rand.org/stats/education/teachsalben.html
********************************************/
...
if(!isset($_SESSION['teachsalben']) || (isset($_SESSION['teachsalben']) && !isset($_SESSION['teachsalben']['dbid']))){
	header('location: teachsalben.php');
}

$searchedfields = $_SESSION['teachsalben'];
...
if(isset($searchedfields['Category'])){
	$fieldsStrWhere .= " and ".$tablesname.".category  = '".$searchedfields['Category']."'";
}
