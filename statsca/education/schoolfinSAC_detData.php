...
if(!isset($_SESSION['schoolfinSAC_det']) || (isset($_SESSION['schoolfinSAC_det']) && !isset($_SESSION['schoolfinSAC_det']['dbid']))){
	header('location: schoolfinSAC_det.php');
}

$searchedfields = $_SESSION['schoolfinSAC_det'];
...
if(isset($searchedfields['us_states'])){
	$cat1s = explode(';', $searchedfields['us_states']);
	foreach($cat1s as $keyCat => $catname){
		$cat1 .= "'".$catname."',";
	}
	$cat1 = substr($cat1, 0, -1);
	$fieldsStrWhere .= " and ".$tablesname.".Cat1 in (".$cat1.") ";
}
