...
* @live URL: http://ca.rand.org/stats/education/sat.html
********************************************/
...
$tablesname				= "sat2";
$tablesnamecats			= "sat2_cats";
$tablesnamecd			= "cd_new";
$tablesnamecds			= "cds";
$tablesnamecounties		= "ca_counties";

if(!isset($_SESSION['sat']) || (isset($_SESSION['sat']) && !isset($_SESSION['v']['dbid']))){
	header('location: sat.php');
}

$searchedfields = $_SESSION['sat'];
