...
* @live URL: http://ca.rand.org/stats/education/teachsalfixed.html
********************************************/
...
if(!isset($_SESSION['teachsalfixed']) || (isset($_SESSION['teachsalfixed']) && !isset($_SESSION['teachsalfixed']['dbid']))){
	header('location: teachsalfixed.php');
}

$searchedfields = $_SESSION['teachsalfixed'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere."  and ".$tablesname.".cds in (".$cds.") and ".$tablesname.".category in (".$category.") ".$joinStr." limit 4000";
