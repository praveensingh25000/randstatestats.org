...
* @live http://ca.rand.org/stats/education/schoolfinSAC.html
********************************************/
...
if(!isset($_SESSION['schoolfinSAC']) || (isset($_SESSION['schoolfinSAC']) && !isset($_SESSION['schoolfinSAC']['dbid']))){
	header('location: schoolfinSAC.php');
}

$searchedfields = $_SESSION['schoolfinSAC'];
