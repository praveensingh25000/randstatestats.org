...
if(isset($searchedfields['Cat2'])){
	...
	$fieldsStrWhere .= " and ".$tablesname.".Cat2 in (".$cat2.") ";
}
...
if(isset($searchedfields['areacode'])){
	...
	$fieldsStrWhere .= " and ".$tablesname.".CDS in (".$area.") ";
}

if(!empty($searchedfields['category'])){
	$category = '';
	foreach($searchedfields['category'] as $categoryss){
		$category.="'".$categoryss."'".',';
	}
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere."  and ".$tablesname.".Cat1 = 'General (201)' ".$joinStr." limit 4000";
