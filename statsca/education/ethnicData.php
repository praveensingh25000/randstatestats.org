...
if(!isset($_SESSION['ethnic']) || (isset($_SESSION['ethnic']) && !isset($_SESSION['ethnic']['dbid']))){
	header('location: ethnic.php');
}

$searchedfields = $_SESSION['ethnic'];
...
if(!empty($searchedfields['Cat1'])){
	...
	$cat1Str = '';
	foreach($searchedfields['Cat1'] as $keyCategory => $cat1){
		$cat1Str .= "'".$cat1."',";
	}
