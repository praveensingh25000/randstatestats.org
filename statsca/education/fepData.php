...
if(!isset($_SESSION['fep']) || (isset($_SESSION['fep']) && !isset($_SESSION['fep']['dbid']))){
	header('location: fep.php');
}

$searchedfields = $_SESSION['fep'];
...
if(isset($searchedfields['Category']) && count($searchedfields['Category'])>0){
	$categoryStr = '';
	foreach($searchedfields['Category'] as $keyC => $category){
