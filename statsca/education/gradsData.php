...
if(!isset($_SESSION['grads']) || (isset($_SESSION['grads']) && !isset($_SESSION['grads']['dbid']))){
	header('location: grads.php');
}

$searchedfields = $_SESSION['grads'];
...
if(isset($searchedfields['schooldistrict'])){
	...
	$fieldsStrWhere .= " and ".$tablesname.".CDS IN (".$schooldistrictStr.")";
}
