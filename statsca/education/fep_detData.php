...
if(!isset($_SESSION['fep_det']) || (isset($_SESSION['fep_det']) && !isset($_SESSION['fep_det']['dbid']))){
	header('location: fep_det.php');
}

$searchedfields = $_SESSION['fep_det'];
...
$sql = "select ".$columnstobefetched." from fepdet, fepdet_cats, cds where 1 ".$fieldsStrWhere."  and ".$tablesname.".Category IN (".$category.") ".$joinStr." limit 4000";
