...
if(!isset($_SESSION['longtermcare_fac']) || (isset($_SESSION['longtermcare_fac']) && !isset($_SESSION['longtermcare_fac']['dbid']))){
	header('location: longtermcare_fac.php');
}

$searchedfields = $_SESSION['longtermcare_fac'];
