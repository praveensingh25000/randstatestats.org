...
* live Site: http://ca.rand.org/stats/health/hosp_util_fac.html
********************************************/
...
if(!isset($_SESSION['hosp_util_fac']) || (isset($_SESSION['hosp_util_fac']) && !isset($_SESSION['hosp_util_fac']['dbid']))){
	header('location: hosp_util_fac.php');
}

$searchedfields = $_SESSION['hosp_util_fac'];
