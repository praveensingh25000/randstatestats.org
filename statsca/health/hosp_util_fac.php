...
if(isset($_POST['getresults'])){
	...
	if(isset($validity_on) && $validity_on == '0') {
		...
		header('location: hosp_util_fac_data.php');
		exit;
	}
}
	...
	<section id="inner-content">
		...
		<div class="categorie-data">
			...
			<form method="post" id="frmPost" name="frmPost" action="" novalidate="novalidate">
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php echo $lang['lbl_enter_county_hos']; ?></span>&nbsp;&nbsp;
					</p>
					<div class="table-div">	
							...
							$("#ca_counties").tokenInput( <?php echo $filtervaluesJsonState ; ?>, { 
								...
								onAdd: function (item) {
											...
											jQuery.ajax({								
												...
												url: URL_SITE+'/statsca/health/hosp_util_fac_ajax.php?dbid=<?php echo $dbid; ?>',
