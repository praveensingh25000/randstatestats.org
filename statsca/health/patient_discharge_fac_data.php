...
* live Site: http://ca.rand.org/stats/health/patient_discharge_fac.html
********************************************/
...
if(!isset($_SESSION['patient_discharge_fac']) || (isset($_SESSION['patient_discharge_fac']) && !isset($_SESSION['patient_discharge_fac']['dbid']))){
	header('location: patient_discharge_fac.php');
}

$searchedfields = $_SESSION['patient_discharge_fac'];
