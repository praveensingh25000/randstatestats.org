...
if(!isset($_SESSION['crimes_us']) || (isset($_SESSION['crimes_us']) && !isset($_SESSION['crimes_us']['dbid']))){
	header('location: crime_us.php');
}

$searchedfields = $_SESSION['crimes_us'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and uscrime_agencies.areacode in (".$area.") and uscrime_returnA.Cat1 in (".$category.") and uscrime_returnA.Category In (".$cats.") ".$joinStr." limit 4000";
