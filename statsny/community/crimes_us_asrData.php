...
if(!isset($_SESSION['crimes_us_asr']) || (isset($_SESSION['crimes_us_asr']) && !isset($_SESSION['crimes_us_asr']['dbid']))){
	header('location: crimes_us_asr.php');
}

$searchedfields = $_SESSION['crimes_us_asr'];
...
$cats = implode(',', $searchedfields['catcode']);
 ...
 $sql = "select distinct ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and uscrime_agencies.areacode in (".$area.") and ".$tablesname.".Cat1 in (".$category.") and ".$tablesname.".Category In (".$cats.") ".$joinStr." limit 4000";
