...
$sql = "select distinct ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".area in (".$areaStr.") and ".$tablesname.".category IN (".$categoryStr.") and ".$tablesname.".cat1 IN (".$cat1Str.") ".$joinStr." limit 4000";
