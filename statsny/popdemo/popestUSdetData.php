...
if(!isset($_SESSION['popestUSdet']) || (isset($_SESSION['popestUSdetpopestUSdet']) && !isset($_SESSION['popestUSdet']['dbid']))){
	header('location: popestUSdet.php');
}

$searchedfields = $_SESSION['popestUSdet'];

$usstates=$searchedfields['Area'][0];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and USpopest.Area in (".$area.") ".$joinStr." limit 4000";
