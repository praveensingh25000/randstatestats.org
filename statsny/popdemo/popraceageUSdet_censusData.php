...
if(!isset($_SESSION['popraceageUSdet_census']) || (isset($_SESSION['popraceageUSdet_census']) && !isset($_SESSION['popraceageUSdet_census']['dbid']))){
	header('location:popraceageUSdet_census.php');
}

$searchedfields = $_SESSION['popraceageUSdet_census'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".area in (".$areaStr.") and ".$tablesname.".category IN (".$categoryStr.") and ".$tablesname.".cat1 IN (".$cat1Str.") ".$joinStr." limit 4000";
