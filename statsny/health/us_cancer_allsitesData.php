...
if(!isset($_SESSION['us_cancer_allsites']) || (isset($_SESSION['us_cancer_allsites']) && !isset($_SESSION['us_cancer_allsites']['dbid']))){
	header('location: us_cancer_allsites.php');
}

$searchedfields = $_SESSION['us_cancer_allsites'];
...
foreach($statesarray as $keytats => $statename){
	$states .= "'".$statename."',";
}
$states = substr($states, 0, -1);


$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".area in (".$states.") and ".$tablesname.".Category in (".$category.") ".$joinStr." limit 4000";
