...
if(!isset($_SESSION['physicianasst']) || (isset($_SESSION['physicianasst']) && !isset($_SESSION['physicianasst']['dbid']))){
	header('location: physicianasst.php');
}

$searchedfields = $_SESSION['physicianasst'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".area in (".$area.") and ".$tablesname.".category IN (".$category.") and txplaces.areacode IN (".$states.") ".$joinStr." limit 4000";
