...
if(!isset($_SESSION['local_govt_spending']) || (isset($_SESSION['local_govt_spending']) && !isset($_SESSION['local_govt_spending']['dbid']))){
	header('location: local_govt_spending_data.php');
}

$searchedfields = $_SESSION['local_govt_spending'];
...
$cat2 = $searchedfields['cat2'];

$area = implode(',', $searchedfields['areacode']);

$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$area.") and ".$tablesname.".Category in (".$category.") and ".$tablesname.".Cat2 = '".$cat2."' ".$joinStr." limit 4000";
