...
#live Site URL For This Page: http://tx.rand.org/stats/govtfin/govt_payroll.html
********************************************/
				...
				$(document).ready(function() {	
					...
					$('#sector').change(function(){
						...
						if(states!='' && states != "NULL"){
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsny/govtfin/govtfinAjax.php',
								type: 'post',
							...
							alert("<?php if(isset($lang['lbl_choose_state_first_us_private_govt_fin'])){ echo $lang['lbl_choose_state_first_us_private_govt_fin']; } ?>");
						}
					});
