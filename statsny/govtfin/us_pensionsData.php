...
if(!isset($_SESSION['us_pensions']) || (isset($_SESSION['us_pensions']) && !isset($_SESSION['us_pensions']['dbid']))){
	header('location: us_pensions.php');
}

$searchedfields = $_SESSION['us_pensions'];
