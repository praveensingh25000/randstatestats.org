...
if(!isset($_SESSION['govtfin']) || (isset($_SESSION['govtfin']) && !isset($_SESSION['govtfin']['dbid']))){
	header('location: govtfin.php');
}

$searchedfields = $_SESSION['govtfin'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$area.") and ".$tablesname.".Category in (".$category.") and ".$tablesname.".Cat2 in (".$cat2.") ".$joinStr." limit 4000";
