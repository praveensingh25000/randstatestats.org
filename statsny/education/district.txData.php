...
if(!isset($_SESSION['district.tx']) || (isset($_SESSION['district.tx']) && !isset($_SESSION['district.tx']['dbid']))){
	header('location: district.tx.php');
}

$searchedfields = $_SESSION['district.tx'];
...
$sql = "select ".$columnstobefetched." from ".$tablesname.", ".$tablesnamecat.", ".$tablesnamearea." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$areacode.") and ".$tablesname.".Category in (".$category.")  ".$joinStr." limit 4000";
