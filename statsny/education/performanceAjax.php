...
* Dependent on: stats/education/performace.php
********************************************/
...
if(isset($_REQUEST['states']) && $_REQUEST['states']!=''){
	...
	if(!empty($dataCat)){
		$data .= '<div class="form-div">
					<p><span class="choose">'.((isset($lang['lbl_select_categories_district_performance']))?$lang['lbl_select_categories_district_performance']:'').'</span>&nbsp;&nbsp;</p>
	...
	$data .= '<div class="form-div">
					<p><span class="choose">'.((isset($lang['lbl_select_districts_staff_performance']))?$lang['lbl_select_districts_staff_performance']:'').'</span>&nbsp;&nbsp;</p></div>';
