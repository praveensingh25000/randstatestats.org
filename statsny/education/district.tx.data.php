...
if(!isset($_SESSION['searchedfieldsdistrict']) || (isset($_SESSION['searchedfieldsdistrict']) && !isset($_SESSION['searchedfieldsdistrict']['dbid']))){
	header('location: district.tx.php');
}

$searchedfields = $_SESSION['searchedfieldsdistrict'];
