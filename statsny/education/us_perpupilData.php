...
if(!isset($_SESSION['us_perpupil']) || (isset($_SESSION['us_perpupil']) && !isset($_SESSION['us_perpupil']['dbid']))){
	header('location: us_perpupil.php');
}

$searchedfields = $_SESSION['us_perpupil'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$area.") ".$joinStr." limit 4000";
