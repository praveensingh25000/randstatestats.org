...
if(!isset($_SESSION['schoolexpend']) || (isset($_SESSION['schoolexpend']) && !isset($_SESSION['schoolexpend']['dbid']))){
	header('location: schoolexpend.php');
}

$searchedfields = $_SESSION['schoolexpend'];
