...
if(!isset($_SESSION['enrollrace']) || (isset($_SESSION['enrollrace']) && !isset($_SESSION['enrollrace']['dbid']))){
	header('location: enrollrace.php');
}

$searchedfields = $_SESSION['enrollrace'];
...
$sql = "select ".$columnstobefetched." from enrollrace, enrollrace_cats, counties_districts where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$area.") and ".$tablesnamecat.".catcode in (".$category.") ".$joinStr." and ".$tableDistricts.".distcode in (".$area1.") limit 4000";
