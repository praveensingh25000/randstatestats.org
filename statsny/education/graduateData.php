...
if(!isset($_SESSION['graduate']) || (isset($_SESSION['graduate']) && !isset($_SESSION['graduate']['dbid']))){
	header('location: graduate.php');
}

$searchedfields = $_SESSION['graduate'];
...
$category = "";
foreach($searchedfields['Cat2'] as $keyCat => $catname){
	$category .= "'".$catname."',";
}
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$areacode.") and ".$tablesname.".Category in (".$catcode.") and ".$tablesname.".Cat2 in (".$category.") ".$joinStr." limit 4000";
