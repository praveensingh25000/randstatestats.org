...
if(!isset($_SESSION['distfinance']) || (isset($_SESSION['distfinance']) && !isset($_SESSION['distfinance']['dbid']))){
	header('location: distfinance.php');
}

$searchedfields = $_SESSION['distfinance'];

$tablesname = "distfinance";
$tablesnamecat= "distfinance_cats";
$tablesnamecounties = "distschools_ny";
...
$areacode = implode(',', $searchedfields['areacode']);

$catcode = implode(',', $searchedfields['catcode']);

$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$areacode.") and ".$tablesname.".Category in (".$catcode.") ".$joinStr." ";
