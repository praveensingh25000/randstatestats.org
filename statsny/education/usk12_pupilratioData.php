...
if(!isset($_SESSION['usk12_pupilratio']) || (isset($_SESSION['usk12_pupilratio']) && !isset($_SESSION['usk12_pupilratio']['dbid']))){
	header('location: usk12_pupilratio.php');
}

$searchedfields = $_SESSION['usk12_pupilratio'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$area.")  ".$joinStr." limit 
4000";
