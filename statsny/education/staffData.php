...
if(!isset($_SESSION['searchedfieldsstaff']) || (isset($_SESSION['searchedfieldsstaff']) && !isset($_SESSION['searchedfieldsstaff']['dbid']))){
	header('location: staff.php');
}

$searchedfields = $_SESSION['searchedfieldsstaff'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$areacode.") and ".$tablesname.".Category in (".$category.") ".$joinStr." limit 4000";
