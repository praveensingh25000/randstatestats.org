...
if(!isset($_SESSION['chapter655']) || (isset($_SESSION['chapter655']) && !isset($_SESSION['chapter655']['dbid']))){
	header('location: chapter655.php');
}

$searchedfields = $_SESSION['chapter655'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".area in (".$areacode.") and ".$tablesname.".Category in (".$category.") ".$joinStr." limit 4000";
