...
if(!isset($_SESSION['performance']) || (isset($_SESSION['performance']) && !isset($_SESSION['performance']['dbid']))){
	header('location: performance.php');
}

$searchedfields = $_SESSION['performance'];

$tablesname = "performancedis";
$tablesnamecats = "performancedis_cats";
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".CDS in (".$areacode.") and ".$tablesname.".Category in (".$catcode.") ".$joinStr." limit 4000";
