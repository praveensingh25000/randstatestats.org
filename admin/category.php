...
<section id="container">
	 ...
	 <div class="main-cell">
		...
		<div class="containerLadmin">
			...
			<legend style="background: #cccccc; font-size: 14px; padding: 5px;"><?php if(isset($categoryDetail) && !empty($categoryDetail)){ echo "Edit"; } else { echo "Add"; } ?>   <?php if(isset($_GET['parent']) && $_GET['parent'] == '1') echo 'Global'; ?> Category</legend>
				...
				<?php if(($total>0 && isset($categoryDetail['parent_id']) && $categoryDetail['parent_id'] != 0) || ($total>0 && !isset($categoryDetail) && !isset($_GET['parent']))) { ?>
					<p>Parent Category</p>
					<div style="padding: 10px 0;">
