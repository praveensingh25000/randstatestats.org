...
if(isset($_POST['submit'])){
	...
	$password_update=$admin->adminForgotPassword($email,md5($password));
	if($password_update>0)
	{
		$msg="<p>Hello admin,</p>";
		$msg.="<p>Your changed password has given below.</p>";
		$msg.="<table width='50%'>";
	    $msg.="<tr><td>Password</td><td>".$password."</td></tr>";
		$msg.="</table>";
		$msg.="<p>You can <a href='".URL_SITE."admin/index.php'>login</a> in this link.</p>";
		$mail=new PHPmailer;
		$mail->isHtml(true);
		...
		$_SESSION['msgsuccess']="<center><font color='red'>Your new password has sent to your mail.Please Check Your Mail.</font></center>";
