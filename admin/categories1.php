...
if((isset($_POST['categoryid']) && isset($_POST['select_category_form']) && $_POST['categoryid']=='0') || (isset($_SESSION['categoryid']) && $_SESSION['categoryid'] =='0' )) {
...
} else if((isset($_POST['categoryid']) && isset($_POST['select_category_form']) && $_POST['categoryid']=='parent') || (isset($_SESSION['categoryid']) && $_SESSION['categoryid'] =='parent' )) {	

	if(isset($_POST['categoryid']) && $_POST['categoryid'] =='parent') {
		$parent_id			= $_SESSION['categoryid'] = trim($_POST['categoryid']);
	}else if(isset($_SESSION['categoryid']) && $_SESSION['categoryid'] =='parent') {
	...
	//$categoriesResult		= $admin->getAllParentCategories();
	$categoriesResult		= $admin->showAllCategories($status=1);
	$total					= $db->count_rows($categoriesResult);
	$categories				= $db->getAll($categoriesResult);
}
...
<section id="container">
	 ...
	 <div class="main-cell">
		...
		<div class="containerLadmin">
			...
			<h2> List of Categories <?php if(isset($total)) echo '( '.$total.' )'; ?></h2><br>
