...
if(!isset($_SESSION['airquality_us']) || (isset($_SESSION['airquality_us']) && !isset($_SESSION['airquality_us']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: airquality_us.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: airquality_us.php');
		exit;
	}
}

$searchedfields = $_SESSION['airquality_us'];
