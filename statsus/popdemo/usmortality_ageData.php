...
if(!isset($_SESSION['usmortality_age']) || (isset($_SESSION['usmortality_age']) && !isset($_SESSION['usmortality_age']['dbid']))){
	...
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: usmortality_age.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".State IN (".$stateStr.") ".$joinStr." limit 4000";
