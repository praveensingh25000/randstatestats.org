...
if(!isset($_SESSION['usk12_pupilratio']) || (isset($_SESSION['usk12_pupilratio']) && !isset($_SESSION['usk12_pupilratio']['dbid']))){
	...
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: usk12_pupilratio.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$area.")  and ".$tablesnameatcat.".catname = 'Pupil-teacher ratio' ".$joinStr." limit 
4000";
