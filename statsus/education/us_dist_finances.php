...
#live Site URL For This Page: http://statestats.rand.org/stats/education/us_dist_finances.html
********************************************/
...
if(isset($_POST['getresults'])){
	...
	if(isset($validity_on) && $validity_on == '0') {
		...
		if(isset($dbnameurl) && $dbnameurl!='') {
			header('location: us_dist_financesData.php?dbc='.$_REQUEST['dbc'].'');			
			exit;
		} else {
				...
				$(document).ready(function() {	
					...
					$('#level').change(function(){
						...
						if(states!='' && states != "NULL"){							
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsus/education/us_dist_finances_ajax.php',
								type: 'post',
