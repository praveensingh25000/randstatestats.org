...
* Dependent on: statsus/education/us_perpupil.php
********************************************/
...
if(isset($_REQUEST['states']) && $_REQUEST['states']!=''){
	...
	$data .= '<div class="form-div">
					<p><span class="choose">'.((isset($lang['lbl_please_choose_other_agency_perpupil']))?$lang['lbl_please_choose_other_agency_perpupil']:'').'</span>&nbsp;&nbsp;</p></div>';
