...
* Dependent on: statsus/education/usk12_reducedlunch.php
********************************************/
...
if(isset($_REQUEST['states']) && $_REQUEST['states']!='' && isset($_REQUEST['sector']) && $_REQUEST['sector']!='' && $_REQUEST['sector']!="null"){
	...
	$data .= '<div class="form-div">
			<p><span class="choose">'.((isset($lang['lbl_select_category_reduced_lunch']))?$lang['lbl_select_category_reduced_lunch']:'').'</span>&nbsp;&nbsp;<input type="checkbox" id="checkallcat">&nbsp;All
			...
			<div class="table-div">
			<select name="catcode[]" id="catcode" class="required" multiple >
	...
	foreach($statesArray as $stateKey => $stateAlpaCode){
		...
		$data .= '<div class="form-div">
					<p><span class="choose">'.((isset($lang['lbl_choose_one_or_more_reduced_lunch']))?$lang['lbl_choose_one_or_more_reduced_lunch']:'').' in '.$_REQUEST['sector'].' '.$lblcities.'.</span>&nbsp;&nbsp;<input type="checkbox" id="checkallcat_'.$stateAlpaCode.'">&nbsp;All
