...
* @live Site URL For This Page: http://statestats.rand.org/stats/education/usk12enroll.html
********************************************/
...
if(!isset($_SESSION['usk12enroll2']) || (isset($_SESSION['usk12enroll2']) && !isset($_SESSION['usk12enroll2']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: usk12enroll.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: usk12enroll.php');
		exit;
	}
}

$searchedfields = $_SESSION['usk12enroll2'];
...
$sql = "select ".$columnstobefetched." from ".$tablesStr." where 1 ".$fieldsStrWhere." and ".$tablesnameatcat.".catcode In (".$catcode.") ".$joinStr." limit 4000";
