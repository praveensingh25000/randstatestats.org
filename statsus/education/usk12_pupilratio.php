...
* @live Site URL For This Page: http://statestats.rand.org/stats/education/usk12_pupilratio.html
********************************************/
...
if(isset($_POST['getresults'])){
	...
	$_SESSION['usk12_pupilratio'] = $_POST;
	...
	if(isset($validity_on) && $validity_on == '0') {
		...
		if(isset($dbnameurl) && $dbnameurl!='') {
			header('location: usk12_pupilratioData.php?dbc='.$_REQUEST['dbc'].'');			
			exit;
		} else {
		header('location: usk12_pupilratioData.php');
		exit;
		}
	}
}
	...
	<section id="inner-content" <?php if(isset($related_DB) && mysql_num_rows($related_DB) <= 0) { ?> class="conatiner-full" <?php } ?>>
		...
		<div class="categorie-data">
			...
			<form method="post" id="frmPost" name="frmPost" action="" novalidate="novalidate">
				...
				<!-- form -->
				<input type="hidden" name="session_setter" value="usk12_pupilratio">
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_states_us_ratio_school'])){ echo $lang['lbl_states_us_ratio_school']; } ?> </span>&nbsp;&nbsp;
					</p>
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_state_ratio'])){ echo $lang['lbl_state_ratio']; } ?> </span>&nbsp;&nbsp;
					</p>
					<div class="table-div">
				...
				<div class="form-div">
					<p>
					   <span class="choose"><?php if(isset($lang['lbl_school_type_ratio'])){ echo $lang['lbl_school_type_ratio']; } ?></span>&nbsp;&nbsp;
					</p>
					<div class="table-div">
				...
				$(document).ready(function() {	
					...
					$('#sector').change(function(){
						...
						if(states!='' && states != "NULL"){
							...
							jQuery.ajax({
								url: '<?php echo URL_SITE; ?>/statsus/education/usk12_pupilratio_ajax.php',
								type: 'post',
