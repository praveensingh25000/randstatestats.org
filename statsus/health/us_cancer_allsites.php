...
* @live URL: http://tx.rand.org/stats/health/us_cancer_allsitesData.html
********************************************/
...
if(isset($_POST['getresults'])){
	...
	if(isset($validity_on) && $validity_on == '0') {
		...
		if(isset($dbnameurl) && $dbnameurl!='') {
			header('location: us_cancer_allsitesData.php?dbc='.$_REQUEST['dbc'].'');			
			exit;
		} else {
		header('location: us_cancer_allsitesData.php');
		exit;
		}
	}
}
					...
					<div class="form-div">
						...
						<div class="table-div">
							<table width="700" cellpadding="6" border="1" summary="" class="collapse">
								...
								<td width="10%" align="center"><input type="checkbox" value="All Cancer Types Combined" class="required" name="category[]"></td>
