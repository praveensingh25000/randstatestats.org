...
if(isset($_SESSION['cat']) && !empty($categoryIDArray) && in_array($_SESSION['cat'],$categoryIDArray)){

	if($_SESSION['cat'] == '1'){

		$tablesnameitems  = "consumer_prices_items";

	} else if($_SESSION['cat'] == '6'){

		$tablesnameitems  = "consumer_prices_health_care_items";

	} else if($_SESSION['cat'] == '53' || $_SESSION['cat'] == '3'){

		$tablesnameitems  = "consumer_prices_education_items";

	} else if($_SESSION['cat'] == '47'){

		$tablesnameitems	= "consumer_prices_energy_items";

	} else if($_SESSION['cat'] == '51'){

		$tablesnameitems  = "consumer_prices_transportation_travel_items";
	}
