...
* live Site: http://statestats.rand.org/stats/economics/fullemployUSnaics.html
********************************************/
...
if(!isset($_SESSION['fullemployUSnaics']) || (isset($_SESSION['fullemployUSnaics']) && !isset($_SESSION['fullemployUSnaics']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: fullemployUSnaics.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: fullemployUSnaics.php');
		exit;
	}
}

$searchedfields = $_SESSION['fullemployUSnaics'];

//echo "<pre>";print_r($searchedfields);echo "</pre>"; die;


$tablesname				= "fullemployUSnaics";
$tablesnamecat			= "fullemployUSnaics_cats";
