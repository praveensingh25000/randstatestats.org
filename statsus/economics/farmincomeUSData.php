...
if(!isset($_SESSION['farmincomeUS']) || (isset($_SESSION['farmincomeUS']) && !isset($_SESSION['farmincomeUS']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: farmincomeUS.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: farmincomeUS.php');
		exit;
	}
}

$searchedfields = $_SESSION['farmincomeUS'];

//echo "<pre>";print_r($searchedfields);echo "</pre>"; die;


$tablesname				= "farmincomeUS";
$tablesnamecat			= "farmincomeUS_cats";
