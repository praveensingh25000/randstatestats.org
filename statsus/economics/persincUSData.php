...
if(!isset($_SESSION['persincUS']) || (isset($_SESSION['persincUS']) && !isset($_SESSION['persincUS']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: persincUS.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: persincUS.php');
		exit;
	}
}

$searchedfields = $_SESSION['persincUS'];
