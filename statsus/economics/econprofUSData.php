...
* live Site: http://statestats.rand.org/stats/economics/econprofUS.html
********************************************/
...
if(!isset($_SESSION['econprofUS']) || (isset($_SESSION['econprofUS']) && !isset($_SESSION['econprofUS']['dbid']))){
	
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: econprofUS.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: econprofUS.php');
		exit;
	}
}

$searchedfields = $_SESSION['econprofUS'];

//echo "<pre>";print_r($searchedfields);echo "</pre>"; die;


$tablesname				= "econprofUS";
$tablesnamecat			= "econprofUS_cats";
