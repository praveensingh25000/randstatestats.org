...
if(!isset($_SESSION['avgwagenaicsUS']) || (isset($_SESSION['avgwagenaicsUS']) && !isset($_SESSION['avgwagenaicsUS']['dbid']))){
	...
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: avgwagenaicsUS.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
...
if(!empty($searchedfields['us_states'])){
...
$sql = "select ".$columnstobefetched." from fips, avgwage2US, avgwage2US_cats, states where 1 ".$fieldsStrWhere." and ".$tablesname.".Area in (".$areaStr.") and ".$tablesname.".Cat2 IN (".$cat2Str.") and ".$tablesname.".Cat3 in (".$cat3Str.")  and ".$tablesname.".Category in (".$categoryStr.") ".$joinStr." limit 4000";
