...
if(!isset($_SESSION['popdensityUSdet']) || (isset($_SESSION['popdensityUSdet']) && !isset($_SESSION['popdensityUSdet']['dbid']))){
	if(isset($_REQUEST['dbc']) && $_REQUEST['dbc']!='') {
		header('location: popdensityUSdet.php?dbc='.$_REQUEST['dbc'].'');			
		exit;
	} else {
		header('location: popdensityUSdet.php');
		exit;
	}
}

$searchedfields = $_SESSION['popdensityUSdet'];
...
<section id="container">
 ...
 <div class="main-cell">	
		...
		?>
			...
			<p>&nbsp;</p>
			<p class="fontbld"><b>Note:&nbsp;</b>Data returned as persons per square mile</p>
			<p>&nbsp;</p>
