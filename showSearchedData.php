...
if(!empty($databaseDetail)){
						...
						if(is_array($valueData)){
							...
							foreach($valueData as $postedFieldKey => $postedFieldValue){
								if(is_integer($postedFieldValue)){
									$inStr .= mysql_real_escape_string(stripslashes($postedFieldValue)).", ";
								} else {
									$inStr .= '"'.mysql_real_escape_string(stripslashes($postedFieldValue)).'", ';
								}
							}					
	...
	if(isset($searchedfields['syear']) && isset($searchedfields['eyear'])){
		...
		if(isset($columns['monthsasrows'])){
			if(isset($columns['monthsasrows']['columns']) && $columns['monthsasrows']['columns']!=''){
				foreach($columns['monthsasrows']['columns'] as $tablename => $columnname){
					...
					if(in_array($columnname, $tableColumnsArray) || in_array(strtoupper($columnname), $tableColumnsArray)){
						...
						for($i=$searchedfields['smonth'];$i<=$searchedfields['emonth'];$i++){
							...
							$inStrMonth .= "'".$embedM.$kj."',";
						}

						$inStrMonth = substr($inStrMonth, 0, -1);
						$fieldsStrWhere .= " and ".$tablename.".".$columnname." in (".$inStrMonth.") ";
		...
		if((mysql_num_rows($searchedDataResult))>0){
			...
			<table id="data-table" class="data-table">
				...
				<tr>
					...
					<td align="left"><?php include('decimal.php'); 
					//echo $fieldValue;
					?></td>
				...
				if(isset($columns['quatersascolumns']) && isset($columns['yearsasrows']) && isset($timeIntervalSettings) && ($timeIntervalSettings['time_format'] == 'SQ-SY-EQ-EY' || $timeIntervalSettings['time_format'] == 'SY-EY')){		// When data is as year q1, q2, q3, q4
					...
					while($rowData = mysql_fetch_assoc($searchedDataResult)){ 
						...
						} else if((array_key_exists('Industry', $rowData) || array_key_exists('industry', $rowData)) && (array_key_exists('Product', $rowData) || array_key_exists('product', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){
							
							$origin = (array_key_exists('Industry', $rowData))?$rowData['Industry']:$rowData['industry'];
							$category = (array_key_exists('Product', $rowData))?$rowData['Product']:$rowData['product'];
							$year = (array_key_exists('Year', $rowData))?$rowData['Year']:$rowData['year'];

							$columnsArrayData[$origin][$category][$year] = $rowData;

						} else if((array_key_exists('Industry', $rowData) || array_key_exists('industry', $rowData)) && (array_key_exists('Seasonal', $rowData) || array_key_exists('seasonal', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){
							
							$origin = (array_key_exists('Industry', $rowData))?$rowData['Industry']:$rowData['industry'];
							$category = (array_key_exists('Seasonal', $rowData))?$rowData['Seasonal']:$rowData['seasonal'];
							$year = (array_key_exists('Year', $rowData))?$rowData['Year']:$rowData['year'];

							$columnsArrayData[$origin][$category][$year] = $rowData;

						} else if((array_key_exists('Ownership', $rowData) || array_key_exists('ownership', $rowData)) && (array_key_exists('Seasonal', $rowData) || array_key_exists('seasonal', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){
							
							$origin = (array_key_exists('Ownership', $rowData))?$rowData['Ownership']:$rowData['ownership'];
							$category = (array_key_exists('Seasonal', $rowData))?$rowData['Seasonal']:$rowData['seasonal'];
							$year = (array_key_exists('Year', $rowData))?$rowData['Year']:$rowData['year'];
					...
					while($rowData = mysql_fetch_assoc($searchedDataResult)){ 
						...
						if((array_key_exists('State', $rowData) || array_key_exists('state', $rowData)) && (array_key_exists('Category', $rowData) || array_key_exists('category', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){	
						...
						} else if( (array_key_exists('Area', $rowData) || array_key_exists('area', $rowData) || array_key_exists('Park', $rowData) || array_key_exists('park', $rowData)) && (array_key_exists('Category', $rowData) || array_key_exists('category', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData)) && (array_key_exists('Type', $rowData) || array_key_exists('type', $rowData))){
						...
						}else if((array_key_exists('Category', $rowData) || array_key_exists('category', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData)) && (array_key_exists('Type', $rowData) || array_key_exists('type', $rowData))){
							
						
							$origin = (array_key_exists('Category', $rowData))?$rowData['Category']:$rowData['category'];
							$category = (array_key_exists('Type', $rowData))?$rowData['Type']:$rowData['type'];
							$year = (array_key_exists('Year', $rowData))?$rowData['Year']:$rowData['year'];

							$columnsArrayData[$origin][$category][$year] = $rowData;
						}else if((array_key_exists('Area', $rowData) || array_key_exists('area', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){
						...
						}else if((array_key_exists('State', $rowData) || array_key_exists('state', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){

							$area = (array_key_exists('State', $rowData))?$rowData['State']:$rowData['state'];
							$category = '';
							$year = (array_key_exists('Year', $rowData))?$rowData['Year']:$rowData['year'];

							$columnsArrayData[$area][$category][$year] = $rowData;

						} else if((array_key_exists('Country', $rowData) || array_key_exists('country', $rowData)) && (array_key_exists('Year', $rowData) || array_key_exists('year', $rowData))){

							$area = (array_key_exists('Country', $rowData))?$rowData['Country']:$rowData['country'];
							$category = '';
							$year = (array_key_exists('Year', $rowData))?$rowData['Year']:$rowData['year'];
