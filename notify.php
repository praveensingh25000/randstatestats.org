...
if(isset($_GET['notifyemail']) && isset($_GET['dbid'])) {
	...
	if(!empty($checkemailalready)) {
		echo 'We will notify you when this database is updated. You may now close this window.<br/>Thank You.';
	} else {
...
?>
<!-- NOTIFY WINDOW -->
<div class="header-popup login-popup notify-box" id="login-box" style="display: none; margin-top: -180.5px; margin-left: -319px;">
	<a class="close" href="#">
		<img alt="Close" title="Close Window" class="btn_close" src="<?php URL_SITE;?>/images/close_pop.png">
	</a> 

	<div id="notify">
		<h3>Notify me when this database is updated</h3>

		<form onsubmit="return fun_send_notify_users('<?php echo $_SESSION['user']['id'];?>','<?php echo $dbid;?>','<?php echo $_SESSION['databaseToBeUse'];?>');"method="POST" id="notifyupdatedform" name="notifyupdatedform" class="signin" action="">
