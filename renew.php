...
<section id="container">	
	<div id="inner-content" class="conatiner-full">
		<h2>Renew Subscription Plan</h2><br>
		<?php
			if(isset($_SESSION['creditcarderror']) && $_SESSION['creditcarderror']!=''){
			?>
			<div style="color:red">
				<a class="close"></a>
				<p><?php echo $_SESSION['creditcarderror']; ?></p>
			</div><!-- notification msgerror -->
			<?php unset($_SESSION['creditcarderror']); ?>
			<br class="clear" />
		<?php } ?>
